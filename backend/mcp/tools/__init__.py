...
from backend.mcp.tools.originals_backfill_tools import register_originals_backfill_tools
...
def register_all_tools(
    ...
    *,
    ...
    register_originals_backfill_tools(registry)
...
__all__ = [
    ...
    "register_originals_backfill_tools",
