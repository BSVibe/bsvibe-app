...
#: STUCK_REVIEW_HINT itself used to assert "the SAME verification failing again", which
#: count-only tracking never measures; reworded to claim only what is actually counted.
STUCK_REVIEW_HINT = (
