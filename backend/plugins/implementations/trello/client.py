...
mirroring :mod:`backend.plugins.implementations.github.client`,
:mod:`backend.plugins.implementations.notion.client` and
:mod:`backend.plugins.implementations.linear.client`.
