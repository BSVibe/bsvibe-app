...
2. The expected head revision (``bundle1_5b_routing_embed``) is stamped
   in ``alembic_version``.
...
def test_fresh_pg_upgrade_round_trip():
    ...
    assert stamped == "bundle1_5b_routing_embed", (
        f"expected head bundle1_5b_routing_embed, got {stamped}"
    )
